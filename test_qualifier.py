...
class T100BasicTests(unittest.TestCase):
    ...
    def test_101_instantiation(self):
        ...
        for attribute in ("title", "author", "content", "publication_date"):
            with self.subTest(attribute=attribute):
                ...
                self.assertEqual(
                    getattr(self, attribute), getattr(self.article, attribute)
                )
    ...
    def test_103_len(self):
        ...
        self.assertTrue(
            hasattr(self.article, "__len__"), msg="Article has no `__len__` method."
        )
...
class T110AdditionalBasicTests(unittest.TestCase):
    ...
    @unittest.skipUnless(
        has_short_introduction, reason="short_introduction not implemented"
    )
    ...
    def test_113_short_introduction_checks_n_characters_plus_one_for_space_newline_char(
        self,
    ):
    ...
    @unittest.skipUnless(
        has_most_common_words, reason="most_common_words not implemented"
    )
...
class T200IntermediateTests(unittest.TestCase):
    ...
    def test_201_unique_id(self):
        ...
        for expected_id, article in enumerate(articles):
            self.assertTrue(
                hasattr(article, "id"), msg="`Article` object has no `id` attribute"
            )
    ...
    def test_202_last_edited(self, local_datetime):
        ...
        self.assertIsNone(
            article.last_edited, "Initial value of last_edited should be None"
        )
...
class T210AdditionalIntermediateTests(unittest.TestCase):
    ...
    def test_212_last_edited_should_stay_none_after_updating_other_attributes(self):
        ...
        for attribute, new_value in new_values:
            try:
                ...
                self.assertIsNone(
                    article.last_edited, "Value of last_edited should still be None"
                )
    ...
    def test_214_last_edited_should_be_unique_for_each_article(self, local_datetime):
        ...
        self.assertIsNone(
            article_one.last_edited, "Initial value of last_edited should be None"
        )
        self.assertIsNone(
            article_two.last_edited, "Initial value of last_edited should be None"
        )
        ...
        self.assertIsNone(
            article_two.last_edited, "last_edited for article_two should still be None"
        )
...
class T300AdvancedTests(unittest.TestCase):
    ...
    def test_302_descriptor_raises_type_error(self):
        ...
        with self.assertRaises(
            TypeError, msg="Setting an incorrect type should raise a TypeError"
        ):
